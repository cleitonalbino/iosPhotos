          ...
          <div key={`content-${index}`}>
            ...
            >
              ...
              <a
                ...
                className="absolute bottom-[120px] right-8 bg-white/90 hover:bg-white text-black px-6 py-3 rounded-full shadow-lg transition-all duration-200 flex items-center gap-2 font-medium z-10"
              ...
              {index === 0 && (
                <div className="absolute bottom-[120px] left-1/2 transform -translate-x-1/2 text-white/70 animate-bounce">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
