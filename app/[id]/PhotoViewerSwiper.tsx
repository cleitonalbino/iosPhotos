                ...
                <div className="hidden md:flex w-full h-full items-center justify-center lg:gap-12 gap-6 bg-gradient-to-br from-gray-900 via-black to-gray-900 lg:px-8 px-4 py-8">
                  ...
                  <div className="hidden lg:flex flex-col gap-6 max-w-md flex-shrink-0">
                    ...
                    <p className="text-gray-500 text-xs">
                      ID: {slide.data.id.substring(0, 13)}...
                    </p>
                  </div>
                  ...
                  <div className="relative flex items-center justify-center h-full">
                    {/* iPhone Frame */}
                    <div className="relative iphone-frame w-auto" style={{
                      height: 'min(844px, calc(100vh - 160px))',
                      aspectRatio: '390/844'
                    }}>
                    {/* iPhone body */}
                    <div className="absolute inset-0 bg-gradient-to-b from-gray-800 to-gray-900 shadow-2xl" style={{
                      borderRadius: 'min(60px, 7%)',
                      borderWidth: 'min(18px, 4.5%)',
                      borderStyle: 'solid',
                      borderColor: '#374151'
                    }}>
                      {/* Dynamic Island - iPhone 15/16 Pro */}
                      <div className="absolute left-1/2 -translate-x-1/2 bg-black z-10 shadow-inner" style={{
                        top: 'min(10px, 1.2%)',
                        width: 'min(125px, 32%)',
                        height: 'min(37px, 4.4%)',
                        borderRadius: 'min(22px, 45%)',
                    ...
                    {/* Desktop action buttons - below iPhone frame */}
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center lg:gap-4 gap-3" style={{
                      bottom: 'min(-80px, -9.5%)'
                    }}>
                    {/* Share button */}
                    <button
                      ...
                      className="bg-white/20 backdrop-blur-md hover:bg-white/30 text-white lg:px-6 px-4 lg:py-3 py-2.5 rounded-full shadow-lg transition-all duration-200 border border-white/20 flex items-center gap-2"
                    ...
                    >
                      ...
                      <span className="text-xs lg:text-sm font-medium">Download</span>
                    </a>
                  </div>
                  </div>
                </div>
